...
/*
    ...
    In design, should use the properties only internal state. If the outside want to use call from behavior like method.
    Like direct use the parent phone, should say please call the phone for me.
